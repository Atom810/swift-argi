...
@dataclass
class ChatRequest(MultiModalRequestMixin, XRequestConfig, ChatCompletionRequestMixin):
    dialogid: str | None = None


@dataclass
class ChatResponse(ChatCompletionResponse):
    dialogid: str | None = None
